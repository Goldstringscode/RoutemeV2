...
-- Ensure columns exist on existing clients table
...
ALTER TABLE clients ADD COLUMN IF NOT EXISTS lat FLOAT8;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS lng FLOAT8;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS time_window TEXT;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS duration INT DEFAULT 30;
...
ALTER TABLE clients ADD COLUMN IF NOT EXISTS condition TEXT;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS last_visit TEXT;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS photo_url TEXT;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS nurse_id UUID;
ALTER TABLE clients ADD COLUMN IF NOT EXISTS medications JSONB;
