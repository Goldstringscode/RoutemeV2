...
export default function StylizedMap({ compact = false, onStopClick }) {
  ...
  useEffect(() => {
    ...
    const map = new mapboxgl.Map({
            ...
            // Use ONLY style.load — it fires on every style load and reload.
            // This catches: initial load, projection change reloads, setTerrain reloads.
            map.on("style.load", () => {
              // ── 1. DEM source + 3D terrain ──
