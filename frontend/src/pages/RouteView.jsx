...
import { Sparkles, Clock, MapPin, Mic, Phone, ChevronRight, Route, Navigation, ExternalLink, ArrowLeft, ArrowRight, ArrowUp, CornerDownRight, CornerUpRight, StickyNote, Eye, Users } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {schedule.length > 0 ? (
        ...
        /* Empty state */
        <div className="rounded-3xl border border-stone-200 bg-white p-8 flex flex-col items-center justify-center text-center min-h-[300px]">
          ...
          <h3 className="font-display text-xl">No route to show</h3>
          <p className="text-sm text-stone-500 mt-1 max-w-sm">
            Add clients and schedule visits to build your route.
          </p>
        </div>
      )}
    </div>
